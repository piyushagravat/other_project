		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 250px;">
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="<?php echo base_url(); ?>assets/images/avatar3.jpg" alt=""/>
									</span>
									<span class="subject">
									<span class="from">
									Richard Doe </span>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="<?php echo base_url(); ?>assets/images/avatar1.jpg" alt=""/>
									</span>
									<span class="subject">
									<span class="from">
									Bob Nilson </span>
				...
				<li class="dropdown dropdown-user">
					...
					<span class="username">
					<?php echo $the_user->username; ?> </span>
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<?php if($this->ion_auth->in_group('admin')){ ?>
						<li>
							<a href="<?php echo site_url('category/add_cat'); ?>">
							Add Category</a>
						</li>						
						<?php } ?>
						<li>
							<a href="<?php echo site_url('category/cat_list'); ?>">
							Category List</a>
						</li>
					</ul>
				</li>
				<li>
					<a href="javascript:;">
					<i class="icon-settings"></i>
					<span class="title">Subcat Management</span>
					<span class="selected"></span>
					<span class="arrow open"></span>
					</a>
					<ul class="sub-menu">
						...
						<?php if($this->ion_auth->in_group('admin')){ ?>
						<li>
							<a href="<?php echo site_url('subcategory/add_subcat'); ?>">
							Add Subcategory</a>
						</li>						
						<?php } ?>
						<li>
							<a href="<?php echo site_url('subcategory/subcat_list'); ?>">
							Subcategory List</a>
						</li>
					</ul>
				</li>
                        ...
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar3.jpg" alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar1.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar4.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar2.jpg" alt="...">
                                    <div class="media-body">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar6.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar7.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar8.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar9.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar10.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/images/avatar11.jpg" alt="...">
                                    <div class="media-body">
                        ...
                        <div class="page-quick-sidebar-item">
                            <div class="page-quick-sidebar-chat-user">
                                ...
                                <div class="page-quick-sidebar-chat-user-messages">
                                    <div class="post out">
                                        <img class="avatar" alt="" src="<?php echo base_url(); ?>assets/images/avatar3.jpg"/>
                                        <div class="message">
                                    ...
                                    <div class="post in">
                                        <img class="avatar" alt="" src="<?php echo base_url(); ?>assets/images/avatar2.jpg"/>
                                        <div class="message">
                                            <span class="arrow"></span>
...
<div class="page-footer">
	<div class="page-footer-inner">
		 2014 &copy; CodeIgniter Core + Metronic by cyberfly.
	</div>
...
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
<script src="<?php echo base_url(); ?>assets/lib/respond.min.js"></script>
<script src="<?php echo base_url(); ?>assets/lib/excanvas.min.js"></script> 
<![endif]-->
